...
public class DbConnection {
    ...
    public Connection connectDatabase() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Lutfen database baglanty bilgilerini duzenleyin!");
        }
        return connection;
    }
    ...
    public ResultSet getPrice(Connection connection, String productName) {
        ...
        String sql = "SELECT * FROM MS_FIYAT_LISTE WHERE HARYT_KODY LIKE "
                + "'%" + productName + "%' OR HARYT_ADY LIKE '%" + productName + "%' OR BARKODY = '" + productName + "'";
     ...
     * @param logicalRef given reference number.
     * @param trcode given reference number.
     * @param clientRef given reference number.
     ...
     *
     */
    public String insertFiche(Connection connection, String tableName, String logicalRef, String ficheNo,
    ...
    public String insertStLine(Connection connection, String tableName,
            int logicalRef, int clientRef, int ficheRef, int itemsRef, int uomRef, int usRef,
            int invoiceRef, Double amount, int prcLogRef, Double price, Double discountPercent, Double discount,
            Double total, int lineNo, int trcode, String time) {
        ...
        sql = "INSERT INTO " + tableName + "(";
        for (int i = 0; i <= column.length - 1; i++) {
            if (!column[i].equals("FAREGBINDDATE")) {
                sql += column[i];
            }
    ...
    public String insertInvoice(Connection connection, String tableName, String logicalRef,
            int clientRef, String ficheNo, String time, Double discount, String total,
    ...
    public String insertClfLine(Connection connection, String tableName, int logRef, int ficheRef,
    ...
    public String insertPaytrans(Connection connection, String tableName, int logRef, int ficheRef,
