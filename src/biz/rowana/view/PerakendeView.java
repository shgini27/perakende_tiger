...
public class PerakendeView extends javax.swing.JFrame {
    ...
    private final String URL_DB = "jdbc:jtds:sqlserver://localhost:1433;databaseName=Logo2";//LOGODBB//Logo2
    private final String USERNAME_DB = "sa";
    private final String PASSWORD_DB = "sb19861905";//logo//sb19861905
    ...
    private void initComponents() {
        ...
        productTable.getColumn(productTable.getColumnName(1)).setPreferredWidth(300);
    ...
    */
    ...
    private void searchTextFieldKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_searchTextFieldKeyPressed
        System.err.println("1. barcode okady typed: "  + "\n2. Char: " + evt.getKeyChar() + "\n 3. Code: " + evt.getKeyCode() + "\n 4. Location: " + evt.getKeyLocation());
        
        if(evt.getKeyCode() == 10){
            System.err.println("text uraaaaaaaaaaaaaaa: " + searchTextField.getText().trim());
            if(searchByOne()){
                searchTextField.setText("");
            }
        }
        ...
        if(evt.getKeyCode() >= 96 && evt.getKeyCode() <= 105){
            System.err.println("setted row new value!!!!!!!!!: " + searchTextField.getText().trim());
            if(productTable.getRowCount() > 0){
                int lastRow = productTable.getRowCount();
                System.err.println("LastRow: " + lastRow);
                Double amnt = Double.valueOf(searchTextField.getText().trim());
                productTable.setValueAt(amnt, (lastRow - 1), 3);
                productTable.setValueAt(String.format("%.2f", (200.3333)), (lastRow - 1), 6);
                searchTextField.setText("");
            }
        }
    ...
    private void productTableKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_productTableKeyPressed
        System.err.println("pressed keyCodeeeeee: " + evt.getKeyCode());
